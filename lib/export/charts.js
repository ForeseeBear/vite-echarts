...
export { install as Funnel3dChart } from "../chart/funnel3d/install";
export { install as Pie3dChart } from "../chart/pie3d/install";
export { install as Ring3dChart } from "../chart/ring3d/install";
