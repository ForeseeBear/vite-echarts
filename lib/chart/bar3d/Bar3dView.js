...
// zrUtil.extend(Model.prototype, require('./barItemStyle'));
	...
	_createEl: function (seriesModel, ecModel, api) {
		...
		data.diff(oldData)
			.add(function (dataIndex) {
				...
				var el = me.elCreator[barType](data, dataIndex, itemModel, layout, isHorizontal, animationModel, seriesModel);
			...
			.update(function (newIndex, oldIndex) {
				...
				if (el) {
					...
					el = me.elCreator[barType](data, newIndex, itemModel, layout, isHorizontal, animationModel, true);
				}
